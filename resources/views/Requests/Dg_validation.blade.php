                    ...
                    @foreach($requests as $request)
                        <tr>
                            ...
                            <td>
                                ...
                                <form action="{{ route('dg.requests.approve', $request->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                ...
                                <form action="{{ route('dg.requests.reject', $request->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    <div class="form-group">
